...
<div>
    <div>
        {#if showMobileMenu}
            <div id="mobileMenu" class="relative z-40 md:hidden" role="dialog" aria-modal="true">
                <div transition:fade class="fixed inset-0 bg-gray-600 bg-opacity-75" />
                <div transition:fly={{ x: -200 }} class="fixed inset-0 z-40 flex">
                    <div
                        transition:fade
            ...
            >
                <div class="flex min-h-0 flex-1 flex-col bg-gray-800">
                    <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
                        <div class="flex flex-shrink-0 items-center px-4">
                            <img class="h-8 w-auto rounded-full" src={logo} alt="Your Company" />
                        </div>
